...
#define CONVERT2RGB_8(FMT, XSTEP, top_y, bottom_y, uv, top_dst, bottom_dst, \
                      cur_x, len)                                           \
  {                                                                         \
...
#define CONVERT2RGB_1(FUNC, XSTEP, top_y, bottom_y, uv, top_dst, bottom_dst, \
                      cur_x, len)                                            \
  {                                                                          \
...
#define NEON_UPSAMPLE_FUNC(FUNC_NAME, FMT, XSTEP)                             \
  static void FUNC_NAME(                                                      \
    ...
    CONVERT2RGB_1(VP8YuvTo##FMT, XSTEP, top_y, bottom_y, r_uv, top_dst,       \
